                    ...
                    steps {
                        script {
                            try {
                                ...
                                postPackage("worker-ui",
                                    CI_REGISTRY_WORKER_UI_IMAGE,
                                    CI_REGISTRY_LATEST,
                                    CI_REGISTRY,
                                    CI_REGISTRY_NAMESPACE,
                                    CI_COMMIT_REF_SLUG,
                    ...
                    steps {
                        script {
                            try {
                                ...
                                postPackage("industry-be",
                                    CI_REGISTRY_INDUSTRY_BE_IMAGE,
                                    CI_REGISTRY_LATEST,
                                    CI_REGISTRY,
                                    CI_REGISTRY_NAMESPACE,
                                    CI_COMMIT_REF_SLUG,
                    ...
                    steps {
                        script {
                            try {
                                ...
                                postPackage("api-lighthouse",
                                    CI_REGISTRY_LIGHTHOUSE_IMAGE,
                                    CI_REGISTRY_LATEST,
                                    CI_REGISTRY,
                                    CI_REGISTRY_NAMESPACE,
                                    CI_COMMIT_REF_SLUG,
